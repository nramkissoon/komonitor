...
description: Komonitor offers a free plan for users that want to try out the service or monitor anything not generating any revenue to cover the costs of a paid subscription.
...
or interest to invest in learning and building DevOps or SRE systems for simpler websites, this is where Komonitor's free Starter Plan comes in.

## Free Uptime Monitoring

At Komonitor, we offer a starter plan for anyone that needs website and API uptime monitoring. This plan is free **forever**, and does not require
...
The following uptime monitoring features are offered to all users, including those on the starter plan:
...
If you want to learn more about the free starter plan offerings, or want to explore our other subscription plans, you can learn more detailed information on the [pricing page](/pricing).
