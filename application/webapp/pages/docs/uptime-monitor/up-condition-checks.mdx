...
Komonitor uses the [Got library](https://www.npmjs.com/package/got) to send HTTP request to your websites and API's during an uptime check. The library allows us to
