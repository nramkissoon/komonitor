---
title: Uptime Monitor Introduction
...
that check various parts of a website's or API's response.

For more information and a guide on using them, read the [dedicated documentation](/docs/uptime-monitor/up-condition-checks).
